...
struct HomeViewControllerMock {
    ...
    static let paginationTestForBatman = SearchItemMock.init(title: "Son of Batman", year: "2014", type: "Movie")
    ...
    static let pleaseMovieSearchText = "Please Search Movie"
    ...
    static let testSearchTextBatman = "batman"
    static let testSearchTextFightClub = "Fight Club"
